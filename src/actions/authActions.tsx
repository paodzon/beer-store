...
export const getCurrentUser: CallableFunction =
  (user: object) => async (dispatch: CallableFunction) => {
    if(!user) return;
...
export const signInUser: CallableFunction =
  ...
  export const signUpUser: CallableFunction = ({email, password, confirmPassword}: SignUp ) => async (dispatch:Dispatch) => {
    dispatch({type:actionTypes.IS_LOADING, payload: true});
...
export const signOutUser: CallableFunction = () => async(dispatch: CallableFunction) => {
